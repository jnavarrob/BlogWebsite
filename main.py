...
from forms import CreatePostForm, CreateRegisterForm, CreateLoginForm, UsersComments
...
def show_post(post_id):
    ...
    comment_form = UsersComments()
    if comment_form.validate_on_submit():
        if not current_user.is_authenticated:
            flash("You need to login to place your comment on this post")
            return redirect(url_for('login'))

        comment = Comments(text=comment_form.comment.data,
